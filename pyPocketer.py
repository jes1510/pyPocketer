			...
			if preferredDirection == 'Y' :	
				...
				if pocketing:		
					...
					for i in range(0,len(xSteps)):	
						...
						try :
							of.write('G1 x' + str(xSteps[idx]) + '\n')
							of.write('G1 y' + str(0 + offset) + '\n')	
							idx = idx + 1
							of.write('G1 x' + str(xSteps[idx]) + '\n' )
			...
			if preferredDirection == 'X' : 
				...
				if pocketing :	  
					...
					for i in range(0,len(ySteps)):	
						...
						try :
							of.write('G1 y' + str(ySteps[idx]) + '\n')
							of.write('G1 x' + str(0 + offset) + '\n')	
							idx = idx + 1
							of.write('G1 y' + str(ySteps[idx]) + '\n' )

						except :		
							of.write('G1 y' + str(yMax) + '\n')
							of.write('G1 x' + str(0 + offset) + '\n')
							break
