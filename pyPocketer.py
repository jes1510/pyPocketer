...
class MainWindow(wx.Frame):
    def __init__(self, parent, title="pyPocketer") :    
        ...
        self.sizer9.Add(self.directionLabel, 1, wx.EXPAND)
        self.sizer9.Add(self.directionBox, 1, wx.EXPAND) 
        
        self.sizer10.Add(self.ofLabel, 1, wx.EXPAND)
        self.sizer10.Add(self.ofBox, 1, wx.EXPAND)  
        
        self.sizer11.Add(self.writeFileButton, 1, wx.EXPAND)  
...
#       self.Bind(wx.EVT_MENU, self.OnSave, menuSave)
    ...
    def writeFile(self, e) :
      ...
      of.write('g0 z' + self.liftBox.GetValue() + '\n')
